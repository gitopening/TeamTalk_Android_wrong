...
public class IMLoginManager extends IMManager {
	...
	public void regist(String userName, String password) {
		logger.i("login#login regist-> userName:%s", userName);
...
//       int cid = IMBaseDefine.LoginCmdID.CID_REGISTER_RES_USER_VALUE;
//       int sid = IMBaseDefine.ServiceID.SID_REGISTER_VALUE;
